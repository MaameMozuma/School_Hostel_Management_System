...
<body> 
    ...
    <form id="myForm" action="login_proc.php" method="POST">  
        <div class="container">
            ...
            <button style="text-decoration: none; color: white;" name="login" type="submit" style="text-decoration: none; color: white;">Log In</button> 
